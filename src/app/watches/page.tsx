...
const Watches = () => {
  const watchData = [
    ...
    { id: 3, name: 'Patek Philippe', price: 25000, description: 'Elegant timepiece', image: '/patek philippe.png' },
    ...
    { id: 6, name: 'Seiko', price: 1000, description: 'Affordable and reliable', image: '/seiko.png' },
  ];
